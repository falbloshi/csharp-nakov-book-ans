...
public class GSM : Display
{
    ...
    public class GSMTest
    {
        ...
        public class Call
        {
            ...
            static void CallHistoryDeleteCall(List<Tuple<string, TimeSpan, DateTime>> CallListHistory)
            {
                ...
                if (numbSelected)
                {
                    try
                    {
                        ...
                        Console.WriteLine("\n Number {0} at  {1,0:hh:\\m\\:ss} - {1:dd-MM-yyyy} deleted", CallListHistory[numb].Item1, CallListHistory[numb].Item3);
                    ...
                    catch (System.ArgumentOutOfRangeException)
                    {
                        ...
                        CallHistoryDeleteCall(CallListHistory);
                    }

                }
                else
                {
                    Console.WriteLine("You wrote wrong number, deleting everything!");
                    CallHistoryDeleteArchive(CallListHistory);
                }


            }

            static void CallHistoryDeleteArchive(List<Tuple<string, TimeSpan, DateTime>> CallListHistory)
            {
            ...
            static void TotalCallPrice(float price)
            {
                ...
                totalPrice = price * (float)totalCallTime.Minutes;
