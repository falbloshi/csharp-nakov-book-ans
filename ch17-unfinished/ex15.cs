...
public class ex15
{
    static void Main()
    {
        ...
        */
        ...
        graph.UAddEdge(1, 3, 2);
        graph.UAddEdge(2, 4, 5);
        graph.UAddEdge(2, 3, 3);
        graph.UAddEdge(3, 4, 4);
        graph.UAddEdge(3, 5, 6);
        graph.UAddEdge(4, 5, 7);
       


        graph.BFS();
        Console.WriteLine($"Weight of 3 and 5: {graph.Distance(3, 5)}");
        Console.WriteLine($"Weight of 4 and 3: {graph.Distance(4, 3)}"); 
        graph.DSPF(0);
